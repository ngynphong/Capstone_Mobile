          ...
          <View className="flex-row justify-between items-start mb-4">
            <View className="flex-1">
              ...
              <Text className="text-gray-600 mb-3">
                {exam.description ||
                  'Comprehensive exam covering various topics'}
              </Text>
            </View>
            <View className="flex-row items-center ml-4">
              <View
                ...
                style={{
                  backgroundColor: getDifficultyDotColor(exam.difficulty),
                }}
              />
              <Text
                className={`text-sm font-medium px-3 py-1 rounded-full ${getDifficultyColor(exam.difficulty)}`}
              >
                {exam.difficulty}
              </Text>
            </View>
